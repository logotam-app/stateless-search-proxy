...
A lightweight Edge proxy designed to sanitize search requests, strip tracking metadata, and cache autocomplete suggestions for sub-second performance globally.
...
---
Built in Kyiv, Ukraine :ukraine:. Code is MIT Licensed.
